            ...
            <div className=' col-10'>
              <form className='row g-3 text-white'>
                ...
                <div className='col-md-6'>
                  ...
                  <input type='password' className='form-control' id='inputPassword' defaultValue={info && info.pass_word} />
                </div>
            ...
            <div className=' col-6'>
              <form className='row g-3 text-white'>
                ...
                <div className='col-md-12'>
                  ...
                  <textarea type='description' className='form-control' id='description'></textarea>
                </div>
